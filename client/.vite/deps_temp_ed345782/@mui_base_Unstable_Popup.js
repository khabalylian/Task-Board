...
var Portal = React13.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime.jsx)(React13.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime.jsx)(React13.Fragment, {
...
var popupClasses = generateUtilityClasses2(COMPONENT_NAME, ["root", "open"]);
...
var TransitionContext = React17.createContext(null);
if (true) {
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React19.useState(true);
  const hasPendingExitTransition = React19.useRef(false);
  const registeredTransitions = React19.useRef(0);
  const [hasTransition, setHasTransition] = React19.useState(false);
  const previousRequestEnter = React19.useRef(requestEnter);
  React19.useEffect(() => {
  ...
  const handleExited = React19.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React19.useCallback(() => {
...
var PopupContext = React20.createContext(null);
if (true) {
...
var _excluded2 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy"];
...
var Popup = React21.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React21.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
  ...
  return (0, import_jsx_runtime3.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime3.jsx)(PopupContext.Provider, {
      value: popupContextValue,
      children: (0, import_jsx_runtime3.jsx)(TransitionContext.Provider, {
        value: contextValue,
...
true ? Popup.propTypes = {
   ...
   */
  anchor: import_prop_types5.default.oneOfType([HTMLElementType, import_prop_types5.default.object, import_prop_types5.default.func]),
  /**
   * @ignore
   */
   ...
   */
  middleware: import_prop_types5.default.arrayOf(import_prop_types5.default.oneOfType([import_prop_types5.default.oneOf([false]), import_prop_types5.default.shape({
    fn: import_prop_types5.default.func.isRequired,
    name: import_prop_types5.default.string.isRequired,
    options: import_prop_types5.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types5.default.oneOfType([import_prop_types5.default.func, import_prop_types5.default.number, import_prop_types5.default.shape({
    alignmentAxis: import_prop_types5.default.number,
    crossAxis: import_prop_types5.default.number,
    mainAxis: import_prop_types5.default.number
  })]),
  /**
